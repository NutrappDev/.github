...
echo "  • Los checks (validate, security, commitlint, release-validate) se disparan"
echo "    via la regla 'workflows' apuntando a org-pr-checks.yml en NutrappDev/.github."
echo "    Los repos NO necesitan pr-checks.yml para que los checks funcionen."
echo "  • pr-checks.yml en cada repo solo es necesario para el auto-tag al mergear releases."
